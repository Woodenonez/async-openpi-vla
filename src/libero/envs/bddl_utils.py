from bddl.parsing import scan_tokens, package_predicates # type: ignore


def get_problem_info(problem_filename: str):
    """
    Get problem information from BDDL problem file.
    
    Args:
        problem_filename (str): Path to the BDDL problem file.
        
    Returns:
        prob_dict (dict): Dictionary containing problem information, including
                          'problem_name', 'domain_name', and 'language_instruction'.
    """
    domain_name = "unknown"
