...
BENCHMARK_MAPPING: dict[str, Type["Benchmark"]] = {}


def register_benchmark(target_class):
    """We design the mapping to be case-INsensitive."""
    BENCHMARK_MAPPING[str(target_class.__name__).lower()] = target_class
...
def get_task_suite(benchmark_name: str):
    benchmark_class = BENCHMARK_MAPPING[benchmark_name.lower()]
...
task_maps: dict[str, dict[str, Task]] = {}
max_len = 0
